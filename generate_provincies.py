...
<nav class="glass-nav fixed top-0 left-0 right-0 z-50 py-4">
  <div class="container" style="display:flex;align-items:center;justify-content:space-between;">
    ...
    <a href="https://app.bylder.com" class="cta-btn px-5 py-2.5 rounded-lg text-sm inline-block">Start gratis <i class="ph-thin ph-arrow-right ml-1 text-xs"></i></a>
  </div>
</nav>
...
<section style="padding:64px 0;">
  <div class="container">
    <div style="display:flex;align-items:end;justify-content:space-between;margin-bottom:32px;flex-wrap:wrap;gap:16px;">
      ...
      <a href="https://app.bylder.com" class="cta-btn px-6 py-3 rounded-xl inline-flex items-center gap-2" style="font-size:13px;">
...
<section style="padding:64px 0;background:#1A1208;text-align:center;">
  <div class="container">
    ...
    <a href="https://app.bylder.com" class="cta-btn px-8 py-4 rounded-xl inline-flex items-center gap-2" style="font-size:14px;">
