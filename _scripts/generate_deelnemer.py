...
NAV = """<nav style="background:rgba(245,240,232,0.95);backdrop-filter:blur(20px);border-bottom:1px solid rgba(61,46,30,0.08);position:sticky;top:0;z-index:50;padding:16px 0;">
  <div style="max-width:1280px;margin:0 auto;padding:0 48px;display:flex;align-items:center;justify-content:space-between;">
    ...
    <div style="display:flex;align-items:center;gap:28px;">
      <a href="/#scan" style="font-size:14px;color:rgba(61,46,30,0.5);text-decoration:none;">QuickScan</a>
      ...
      <a href="/over-ons/" style="font-size:14px;color:rgba(61,46,30,0.5);text-decoration:none;">Over ons</a>
...
SEGMENTS = [
 dict(slug='woonwinkels-merken', naam='Woonwinkels & merken',
  ...
  cards=[('Voucher op het koopmoment','Jouw korting verschijnt wanneer de koper aan jouw categorie toe is — geen strooibudget, wel timing.'),
