...
SEGMENTS = [
 ...
 dict(slug='interieurbouw', naam='Interieurbouw',
  ...
  desc='Interieurbouwers en maatwerk-meubelmakers: sta in de op-maat-gids van Bylder en ontvang opdrachten van kopers die hun nieuwbouw- of verbouwwoning inrichten. €79 per jaar.',
  ...
  stats=[('12','op-maat-categorieën'), ('€79','per jaar'), ('0','kosten per lead')],
  ...
  price=('€79 per jaar', 'Activeer je profiel voor €79 per jaar. Geen kosten per aanvraag — hetzelfde model als voor vakbedrijven.'),
  cta=('Activeer je profiel','mailto:info@bylder.com?subject=Deelnemen%20interieurbouw'),
  faq=[('Wat krijg ik voor €79?','Een permanent profiel in de op-maat-gids met portfolio, specialisaties en contactmogelijkheid, plus doorverwijzingen vanuit de ontwerptools. €79 per jaar, geen kosten per lead.'),
 ...
 dict(slug='interieurontwerp-architecten', naam='Interieurontwerp & architecten',
  ...
  desc='Interieurontwerpers en architecten: ontvang klanten op het ontwerpmoment. Kopers starten met AI-tools en schakelen door naar een professional. €79 per jaar.',
  ...
  stats=[('8','AI-ontwerptools als lead-in'), ('€79','per jaar'), ('0','commissie per opdracht')],
  ...
  price=('€79 per jaar', 'Activeer je profiel voor €79 per jaar. Geen commissie over je honorarium.'),
  ...
  faq=[('Voor wie is dit segment?','Interieurontwerpers, interieurarchitecten en (verbouw)architecten die voor particulieren werken.'),
       ...
       ('Rekent Bylder commissie?','Nee. Je betaalt €79 per jaar voor je profiel; wat je met de klant afspreekt is aan jou.')],
...
def render_hub():
    ...
    segs=[("/deelnemer-worden/woonwinkels-merken/","Woonwinkels & merken","Vouchers, Showroomsale en productplaatsing in de ontwerptools — op het juiste koopmoment.","Gratis instap"),
          ("/voor-vakbedrijven/","Vakbedrijven","Sta in de directory waar kopers je zoeken. Geen abonnement, geen leadveiling.","€79 per jaar"),
          ...
          ("/deelnemer-worden/interieurbouw/","Interieurbouw","Maatwerk-opdrachten uit de op-maat-gids en de ontwerptools.","€79 per jaar"),
          ("/deelnemer-worden/interieurontwerp-architecten/","Interieurontwerp & architecten","Warme aanvragen op het ontwerpmoment, met AI-schets als startpunt.","€79 per jaar"),
