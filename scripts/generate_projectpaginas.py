...
<a href="/wonen-in/{E(p['plaats'])}/">wonen in {E(plaats)}</a>.</p>
    ...
    # De titel begint met de projectnaam, want dáár zocht de bezoeker op. Wat
    # erachter komt is de reden om te klikken, en dat past bewust binnen de
    # afkapgrens in plaats van dat kort_titel() er een puntje achter zet: een
    # halve belofte leest slechter dan een korte.
...
def main():
    ...
    if not DRY:
        ...
        # maar ze zijn wél de best presterende van het cluster (91 van de 103
