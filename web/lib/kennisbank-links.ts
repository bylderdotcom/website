...
// container van het cluster. Zonder eigen breedte liep het over de volle
// schermbreedte en begon de tekst tegen de linkerrand. Zelfde maat als de
// container erboven, zodat het uitlijnt met de rest van de pagina.
function blok(keys: string[]): string {
  const links = keys
    ...
    .join('')
  return (
    `<section style="max-width:1200px;margin:40px auto 0;padding:24px 24px 0;border-top:1px solid rgba(61,46,30,0.1);">` +
