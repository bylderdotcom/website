// Data-gedreven cluster-renderer voor /gereedschap-lenen/.
// Zelfde patroon als lib/bouwvergunning.ts: canonieke datalaag op build-time
// (data/clusters/gereedschap-lenen/ JSON + content-fragmenten, gedeelde
// templates/clusters/gereedschap-lenen/ CSS). Dit cluster kent geen aside-
...
const CLUSTER = 'gereedschap-lenen'
