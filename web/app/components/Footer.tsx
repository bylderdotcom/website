...
const COLS: Col[] = [
  ...
  { title: 'Vakmannen', links: [
    { href: '/aannemer-matching/loodgieter/', label: 'Loodgieter vinden' },
    { href: '/aannemer-matching/elektricien/', label: 'Elektricien vinden' },
    { href: '/aannemer-matching/schilder/', label: 'Schilder vinden' },
    { href: '/renovatiekosten/badkamer/', label: 'Badkamer kosten' },
    { href: '/offerte-check/schilder/', label: 'Offerte check' },
    { href: '/aannemer-matching/', label: 'Alle vaklieden →', accent: true },
  ] },
