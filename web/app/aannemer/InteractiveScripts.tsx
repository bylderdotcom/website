...
// Herbedraadt wat de inline <script>-blokken in de aannemer-contenttemplates
...
export default function InteractiveScripts() {
  useEffect(() => {
    ...
    cleanups.push(wireKlusCheck({
      W: [{ low: 15000, high: 60000 }, { low: 10000, high: 80000 }, { low: 7000, high: 18000 }, { low: 1500, high: 5000 }, { low: 5000, high: 25000 },],
      noot: 'indicatief, per project, excl. btw',
    }))
