    ...
    <div className="fn-root">
      ...
      <section className="section"><div className="container">
        ...
        <div className="grid wt-grid" style={grid('nieuwbouw')}>
          ...
          <Card icoR icon="ph-thin ph-tag" title="Kortingsvouchers" tag={LID}>Ledenkorting bij 56 woonmerken zoals Auping, Goossens en DRT — codes direct actief, gratis voor bewoners.</Card>
        ...
        <div className="grid wt-grid" style={grid('bestaand')}>
          ...
          <Card icoR icon="ph-thin ph-tag" title="Kortingsvouchers" tag={LID}>Ledenkorting bij 56 woonmerken voor je inrichting en verbouwing.</Card>
        ...
        <div className="grid wt-grid" style={grid('renovatie')}>
          ...
          <Card icon="ph-thin ph-clipboard-text" title="Bouwvergunning-hulp" tag={LID}><BouwvergunningBody /></Card>
          <Card icoR icon="ph-thin ph-tag" title="Kortingsvouchers" tag={LID}>Ledenkorting bij 56 woonmerken voor je verbouwing en inrichting.</Card>
