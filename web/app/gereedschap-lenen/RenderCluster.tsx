import type { ClusterPage } from '../../lib/gereedschap-lenen'
import { getMainHtml, getClusterCss } from '../../lib/gereedschap-lenen'

// Server-component: rendert één gereedschap-lenen-clusterpagina. Cluster-CSS +
