...
// Herbedraadt wat de inline <script>-blokken in de badkamer-contenttemplates
...
export default function InteractiveScripts() {
  useEffect(() => {
    ...
    cleanups.push(wireKlusCheck({
      W: [{ low: 8000, high: 20000 }, { low: 5000, high: 10000 }, { low: 20000, high: 40000 }, { low: 1500, high: 4000 }, { low: 1500, high: 4000 },],
