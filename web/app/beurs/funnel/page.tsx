        ...
        <ul style={{ listStyle: 'none', margin: 0, padding: 0, display: 'grid', gap: 10 }}>
          {[
            ...
            ['Acht houtdecors zitten in de configurator.',
             'Het Unilin-materiaal was ruim bruikbaar. Oslo Oak tanned red ging er op 15 september in; van de zeven die Thijs op 16 september nastuurde staan er nu vijf bij — Oslo Oak cocoa brown, Dainty Oak latte, Master Oak natural, Master Oak patina en Kivu Wenge. Twee daarvan bleken fineer in plaats van HPL en zijn er op zijn aangeven weer uit. Kies bij Afwerking \u201cFineer\u201d en dan een decor. Elke nerf ligt op ware grootte: de maat staat in het V-Ray-bestand, en die verschilt per decor — van 1300 bij 1300 mm tot 3040 bij 1270 mm, een hele plaat.'],
