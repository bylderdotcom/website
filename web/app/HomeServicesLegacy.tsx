// LEGACY — homepage vóór de herpositionering van 10 jul 2026 ('Alles voor je (nieuwe)
// woning'). Terugzetten: in HomeClient.tsx en page.tsx de imports naar dit bestand wijzen
// (en HomeServicesLegacy). Bewust bewaard op verzoek van Daniel.
