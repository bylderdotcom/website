...
// Herbedraadt de 2 inline <script>-blokken uit de elektricien-contenttemplates
...
// per klus, geen m²-invoer, berekent al bij laden, zoals loodgieter/aannemer)
// en, alleen op stadspagina's, de sorteer-dropdown voor de bedrijvengrid
// (#dir-sort/#dir-grid, byte-identiek aan de vorige 4 clusters). Elementen
  ...
  useEffect(() => {
    ...
    if (s && o) {
      ...
      const calc = () => {
        ...
        o.innerHTML = `Indicatie: <strong>€${fmt(w.low)} – €${fmt(w.high)}</strong> <span style="color:rgba(61,46,30,0.5);font-size:13px;">(indicatief, per klus, excl. voorrijkosten/btw)</span>`
      }
