/* Leest een verkoop- of meerwerktekening (vector-PDF) en maakt er een woningmodel van.
   Werkt in de browser en in node: alleen pdfjsLib wordt van buiten meegegeven.

   Wat eruit komt, per pagina = verdieping:
     naam, schaal, wanden [x0,y0,x1,y1,meerwerk] in mm, ruimtes [{naam, x, y, m2}],
     kap {nokY, zNok, k} als er hoogtelijnen op staan. */
(function (root) {
  'use strict';
  ...
  root.BylderTekening = { leesPdf: leesPdf };
