...
SPOKES = [
    ...
    {"slug": "mooie-plattegrond",
     ...
     "desc": "Zet je technische bouwtekening om in een mooie, ingekleurde plattegrond — met warme materialen en duidelijke ruimtes. In je browser bij Bylder.",
     "intro": "Een technische bouwtekening is functioneel, maar koud en lastig te lezen. Bylder maakt er met één klik een <strong>warme, ingekleurde plattegrond</strong> van &mdash; strak, duidelijk en prettig om naar te kijken. Zo wordt je woning meteen tastbaarder.",
     "bullets": ["Upload je bouwtekening of plattegrond.", "Eén klik &rarr; een clean, ingekleurde 2D-plattegrond met warme materialen.", "Je indeling blijft kloppen &mdash; alleen mooier en duidelijker.", "Wil je verder? Pas je meubels in en render 'm in 3D in jouw stijl."],
     "faq": [("Hoe maak ik mijn plattegrond mooi?", "Upload je technische tekening en Bylder maakt er met AI een nette, ingekleurde plattegrond van &mdash; met warme vloeren en duidelijke ruimtes, in je browser."),
             ("Blijft mijn indeling kloppen?", "Ja. De opmaak houdt je plattegrond-indeling aan; het maakt 'm vooral mooier, warmer en makkelijker te lezen.")]},
    {"slug": "online-gratis",
